...
#ifndef Observables_G2dLattice_H
#define Observables_G2dLattice_H

#define PI acos(-1.0)

class Observables_G2dLattice
{
public:
    Observables_G2dLattice(Parameters_G2dLattice &Parameters__, Coordinates_G2dLattice &Coordinates__,
...
/*
 * ***********
 *  Functions in Class Observables_G2dLattice ------
 *  ***********
*/
...
void Observables_G2dLattice::Calculate_Local_spins_resolved(){
...
void Observables_G2dLattice::Calculate_Akxw_ribbon()
{
...
void Observables_G2dLattice::Calculate_Nw()
{
...
void Observables_G2dLattice::Calculate_OrbResolved_Nw()
{
...
double Observables_G2dLattice::Lorentzian(double x, double brd)
{
    double temp;
...
double Observables_G2dLattice::fermi_function(int n)
{
    double value;
...
void Observables_G2dLattice::calculate_quantum_SiSj()
{
    /*
...
void Observables_G2dLattice::calculate_local_density()
{
    int c1;
...
void Observables_G2dLattice::Initialize()
{
...
#endif // Observables_G2dLattice_H
