...
#ifndef Connections_G2dLattice_class
#define Connections_G2dLattice_class


class Connections_G2dLattice
{
public:
Connections_G2dLattice(Parameters_G2dLattice &Parameters__, Coordinates_G2dLattice &Coordinates__)
...
void Connections_G2dLattice::Get_minimum_distance_direction(int l,int gamma_l, int m, int gamma_m, int &r1_, int &r2_, double &dis_min){


//in this routine, gamma_l(m) is atom index
cout<<"Connections_G2dLattice::Get_minimum_distan... is not generic yet"<<endl;
assert(false);
...
void Connections_G2dLattice::Initialize()
{
...
void Connections_G2dLattice::Print_Ansatz_LocalDen_CDW(){
...
void Connections_G2dLattice::InteractionsCreate()
{
...
void Connections_G2dLattice::Interactions_Sorting()
{

} // ----------


void Connections_G2dLattice::Check_up_down_symmetry()

{

}

void Connections_G2dLattice::Check_Hermiticity()
...
void Connections_G2dLattice::HTBCreate()
{
...
void Connections_G2dLattice::Print_Hopping(){
...
void Connections_G2dLattice::Print_LongRangeInt(){
