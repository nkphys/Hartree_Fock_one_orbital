...
subltc_= int((1.0*temp_int+0.5)/(2.0));
//subltc_=temp_int%2;
//orb_no_= int((1.0*temp_int+0.5)/(2.0));
                                    ...
                                    for(int gamma_p=0;gamma_p<n_atoms_*n_orbs_;gamma_p++){
                                        for(int sigma_p=0;sigma_p<2;sigma_p++){
                                            ...
                                            if(row_!=col_){
                                                ...
                                                //         chk_str="false";
                                                //     }
                                                //     cout<<row_<<"  "<<col_<<"  "<<"Check : "<<(alpha_p + gamma_p*(S_) +  sigma_p*(n_atoms_*n_orbs_*S_))<<"  "<<(alpha + gamma*(S_) +  sigma*(n_atoms_*n_orbs_*S_))<<"  "<<chk_str<<endl;
                                                //     }
