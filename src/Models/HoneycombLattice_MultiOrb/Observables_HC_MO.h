...
#ifndef Observables_HC_MO_H
#define Observables_HC_MO_H

#define PI acos(-1.0)

class Observables_HC_MO
{
public:
    Observables_HC_MO(Parameters_HC_MO &Parameters__, Coordinates_HC_MO &Coordinates__,
                   Connections_HC_MO &Connections__)
...
/*
 * ***********
 *  Functions in Class Observables_HC_MO ------
 *  ***********
*/
...
void Observables_HC_MO::Calculate_Local_spins_resolved(){
...
void Observables_HC_MO::Calculate_Akxw_ribbon()
{
...
void Observables_HC_MO::Calculate_Akw()
{
...
void Observables_HC_MO::Calculate_Nw()
{
...
void Observables_HC_MO::Calculate_OrbResolved_Nw()
{
...
double Observables_HC_MO::Lorentzian(double x, double brd)
{
    double temp;
...
double Observables_HC_MO::fermi_function(int n)
{
    double value;
...
void Observables_HC_MO::calculate_quantum_SiSj()
{
    /*
...
void Observables_HC_MO::calculate_local_density()
{
    int c1;
...
void Observables_HC_MO::Initialize()
{
