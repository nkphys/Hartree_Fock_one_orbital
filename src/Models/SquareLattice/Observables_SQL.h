...
#include "Connections_SQL.h"

#ifndef Observables_SQL_H
#define Observables_SQL_H

#define PI acos(-1.0)

class Observables_SQL
{
public:
    Observables_SQL(Parameters_SQL &Parameters__, Coordinates_SQL &Coordinates__,
                Connections_SQL &Connections__)
...
/*
 * ***********
 *  Functions in Class Observables_SQL ------
 *  ***********
*/


void Observables_SQL::Calculate_Akw()
{
...
void Observables_SQL::Calculate_Nw()
{

    //---------Read from input file-----------------------//
    string fileout = "Nw_total_SQL.txt" ;
    double omega_min, omega_max, d_omega;
    double eta = Parameters_.eta;
    ...
    ofstream spectrum;
    spectrum.open("spectrum_SQL.txt");
...
void Observables_SQL::Calculate_OrbResolved_Nw()
{
...
double Observables_SQL::Lorentzian(double x, double brd)
{
    double temp;
...
double Observables_SQL::fermi_function(int n)
{
    double value;
...
void Observables_SQL::calculate_quantum_SiSj()
{
    /*
...
void Observables_SQL::calculate_local_density()
{
    int c1;
...
void Observables_SQL::Initialize()
{
