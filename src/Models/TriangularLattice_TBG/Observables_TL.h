...
#ifndef Observables_TL_H
#define Observables_TL_H
...
{
public:
    Observables_TL(Parameters_TL &Parameters__, Coordinates_TL &Coordinates__,
...
/*
 * ***********
 *  Functions in Class Observables_TL ------
 *  ***********
*/
...
void Observables_TL::Calculate_Local_spins_resolved(){
...
void Observables_TL::Calculate_Akw()
{
...
void Observables_TL::Calculate_Nw()
{
...
void Observables_TL::Calculate_OrbResolved_Nw()
{
...
double Observables_TL::Lorentzian(double x, double brd)
{
    double temp;
...
double Observables_TL::fermi_function(int n)
{
    double value;
...
void Observables_TL::calculate_quantum_SiSj()
{
    /*
...
void Observables_TL::calculate_local_density()
{
    int c1;
