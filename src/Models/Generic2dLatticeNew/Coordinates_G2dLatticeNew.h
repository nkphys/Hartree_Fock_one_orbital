...
#ifndef Coordinates_G2dLatticeNew_class
#define Coordinates_G2dLatticeNew_class
class Coordinates_G2dLatticeNew {

public:
    Coordinates_G2dLatticeNew(int lx, int ly, int n_atoms, int n_orbs)
...
int Coordinates_G2dLatticeNew::indx_basiswise(int i){
...
int Coordinates_G2dLatticeNew::indy_cellwise(int i){
    if(i>ncells_-1){perror("Coordinates_G2dLattice.h:y-coordinate of lattice excede limit");}
    return indy_cellwise_[i];
    // ----------
}

int Coordinates_G2dLatticeNew::Nbasis(int x, int y, int gamma){
...
int Coordinates_G2dLatticeNew::Ncell(int x, int y){
    if(!(x<lx_&& y<ly_)){
        cout<<x<<"   "<<y<<endl;
...
int Coordinates_G2dLatticeNew::neigh(int cell, int wneigh){
...
void Coordinates_G2dLatticeNew::Numbering(){
...
int Coordinates_G2dLatticeNew::getneigh(int site,int wneigh){
