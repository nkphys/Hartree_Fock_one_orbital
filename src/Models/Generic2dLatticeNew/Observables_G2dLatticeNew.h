...
#ifndef Observables_G2dLatticeNew_H
#define Observables_G2dLatticeNew_H

#define PI acos(-1.0)

class Observables_G2dLatticeNew
{
public:
    Observables_G2dLatticeNew(Parameters_G2dLatticeNew &Parameters__, Coordinates_G2dLatticeNew &Coordinates__,
                   Connections_G2dLatticeNew &Connections__)
...
/*
 * ***********
 *  Functions in Class Observables_G2dLatticeNew ------
 *  ***********
*/
...
void Observables_G2dLatticeNew::Calculate_Local_spins_resolved(){
...
void Observables_G2dLatticeNew::Calculate_Akxw_ribbon()
{
...
void Observables_G2dLatticeNew::Calculate_Akw()
{
...
void Observables_G2dLatticeNew::Calculate_Nw()
{
...
void Observables_G2dLatticeNew::Calculate_OrbResolved_Nw()
{
...
double Observables_G2dLatticeNew::Lorentzian(double x, double brd)
{
    double temp;
...
double Observables_G2dLatticeNew::fermi_function(int n)
{
    double value;
...
void Observables_G2dLatticeNew::calculate_quantum_SiSj()
{
    /*
...
void Observables_G2dLatticeNew::calculate_local_density()
{
    int c1;
...
void Observables_G2dLatticeNew::Initialize()
{
...
#endif // Observables_G2dLatticeNew_H
