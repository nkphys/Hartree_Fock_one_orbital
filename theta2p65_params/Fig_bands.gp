...
set ytics ( '\fontsize{16}{60}\selectfont-$30$' -30,  '\fontsize{16}{60}\selectfont-$15$' -15,'\fontsize{16}{60}\selectfont$0$' 0,  '\fontsize{16}{60}\selectfont$15$' 15, '\fontsize{16}{60}\selectfont$6$' 30)
...
#p "Bands_Path5_0.0001000000.txt" u ($1*6):4 w p pt 4 ps 2 lc "black" lw 2 ti "", "Bands_Path5_0.0001000000.txt" u ($1*6):6 w p pt 4 ps 2 lc "black" lw 2  ti "", "Bands_Path5_0.0001000000.txt" u ($1*6):8 w p pt 4 ps 2 lc "black" lw 2  ti "", "Bands_Path5_0.0001000000.txt" u ($1*6):10 w p pt 4 ps 2 lc "black" lw 2  ti "", "Bands_energy_144_kpoints.txt" u 1:($8+73.5) w l lw 4 lc "blue" ti "", "Bands_energy_144_kpoints.txt" u 1:($9+73.5) w l lw 4 lc "blue" ti "", "Bands_energy_144_kpoints.txt" u 1:($10+73.5) w l lw 4 lc "blue" ti "", "Bands_energy_144_kpoints.txt" u 1:($11+73.5) w l lw 4 lc "blue" ti ""

p "Bands_energy_144_kpoints.txt" u 1:($8+73.5) w l lw 4 lc "blue" ti "", "Bands_energy_144_kpoints.txt" u 1:($9+73.5) w l lw 4 lc "blue" ti "", "Bands_energy_144_kpoints.txt" u 1:($10+73.5) w l lw 4 lc "blue" ti "", "Bands_energy_144_kpoints.txt" u 1:($11+73.5) w l lw 4 lc "blue" ti ""
