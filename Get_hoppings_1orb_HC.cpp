...
Thop.resize(N_dofs);
for(int dof1=0;dof1<N_dofs;dof1++){
Thop[dof1].resize(N_dofs);
for(int dof2=0;dof2<N_dofs;dof2++){
...
if(dis_<Dis_max){
val_= abs(abs(1.0*spin1-1.0*spin2)-1.0)*Thop[N_orbs*atom1+orb1][N_orbs*atom2+orb2][i1_center][i2_center];
}
else{
val_=0.0;
}
...
if(dis_<Dis_max){
val_= abs(abs(1.0*spin1-1.0*spin2)-1.0)*Thop[N_orbs*atom1+orb1][N_orbs*atom2+orb2][i1_center-1][i2_center];
}
else{
val_=0.0;
}
...
if(dis_<Dis_max){
val_= abs(abs(1.0*spin1-1.0*spin2)-1.0)*Thop[N_orbs*atom1+orb1][N_orbs*atom2+orb2][i1_center][i2_center+1];
}
else{
val_=0.0;
}
...
if(dis_<Dis_max){
val_= abs(abs(1.0*spin1-1.0*spin2)-1.0)*Thop[2*N_orbs*atom1+orb1][2*N_orbs*atom2+orb2][i1_center+1][i2_center-1];
}
else{
val_=0.0;
}
...
if(dis_<Dis_max){
val_= abs(abs(1.0*spin1-1.0*spin2)-1.0)*Thop[N_orbs*atom1+orb1][N_orbs*atom2+orb2][i1_center-1][i2_center+1];
}
else{
val_=0.0;
}
...
if(dis_<Dis_max){
val_= abs(abs(1.0*spin1-1.0*spin2)-1.0)*Thop[N_orbs*atom1+orb1][N_orbs*atom2+orb2][i1_center-1][i2_center+2];
}
else{
val_=0.0;
}
